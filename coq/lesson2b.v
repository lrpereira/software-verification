...
*)
Theorem ex : forall (A:Set) (l1 l2:list A),
...
Proof using.
  ...
  - constructor.
  - destruct n.
    + simpl. apply Even_step. apply Even_base.
    +
Abort.
*)
      (*
...
Lemma even_n_odd_succ_n : forall n:nat, (Even n) -> (Odd (S n)).
Proof using.
  intros.
  induction n.
  - apply Odd_base.
  - induction n.
    + apply Odd_step. apply Odd_base.
       *)
